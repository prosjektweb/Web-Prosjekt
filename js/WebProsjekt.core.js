/**
 * The root address of the document, this is set by the php code
 * 
 * @type String|url
 */
var _root = "";
...
/**
 * Promt the user for confirmation with the given messsage and if confirmed
 * redirect user to the given url
 * 
 * @param msg
 * @param url
 */
function wp_do_confirm(msg, url) {
	if (confirm(msg)) {
		wp_redirect(url);
	}
}
